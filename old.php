...
<body>
    ...
    <section id="food">
        ...
        <div class="section2">
            ...
            <div class="food1 clearfix">
                <h3>allen kitchen</h3>
                <p>
                    <img src="allen-kitchen.jpg"  width="310" height="300">
                    ...
                    Where:40/1, Jatindra Mohan Avenue, Shobha Bazaar.
                </p>
            ...
            <div class="food1 clearfix">
                ...
                <p>
                <img src="golbari.jpg"  width="310" height="300">
            ...
            <div class="food1 clearfix">
                ...
                <p>
                    <img src="fluryaposs.jpg"  width="310" height="300">
                  ...
                  <br>Where:<br>
                  18, Park Street, Park Street Area</p>
            </div>  
            <div class="food1 clearfix">
                
                <h3> Dilkusha Cabin</h3>
                
                <p>
                    <img src="dilkhusha-cabin.jpg"  width="310" height="300">
            ...
            <div class="food1 clearfix">
                <h3>Anadi Cabin</h3>
                <p>
                    <img src="anadi-cabin.jpg"  width="310" height="300">
            ...
            <div class="food1 clearfix">
                <h3>Peter-cat</h3>
                <p>
                    <img src="peter-cat.jpg"  width="310" height="300">
                    For all those who know Kolkata, even a little bit will realise that Park Street will be a frequent on this list with a large number of legendary restaurants its boasts of, one of them being Peter Cat. Located in Park Street, Peter Cat popularised for its unique Chelo Kebab has been in the business since 1975. Their Chelo Kebab Platter which is a combination of buttered rice with poached eggs and grilled kebabs and veggies is so unique that it is no surprise that you will often see customers queuing up for the privilege of tasting the specials, especially during the festivals and the New Year’s.    
                     Where: <br>
                    18A, Park Street, Park Street Area</p>
                </div>
            <div class="food1 clearfix">
            
                <h3>Aminia</h3>
                <p>
                    <img src="aminia.jpg"  width="310" height="300">
                   ...
                   <br> Where: <br>
                    6A, S.N. Banerjee Road, New Market Area</p>
            </div>
            <div class="food1 clearfix">   
           
                <h3>Mocambo</h3>
                <p>
                    <img src="mocambo.jpg"  width="310" height="300">
            ...
            <div class="food1 clearfix"></div>
            
                <h3>Royal Indian Hotel</h3>
                <p>
                    <img src="royal-indian-hotel.jpg"  width="310" height="300">
                 ...
                 147, Rabindra Sarani, Bara Bazar
                    ...
                    <br> Must Have: <br>
                  Chicken/ Mutton Biryani, Mutton Chaap</p>
            </div>
            <!--div class="food1 clearfix"></div>
            
                <h3>Amber</h3>
                <p>
                    <img src="mitra.jpg"  width="310" height="300">
            ...
            <div class="food1 clearfix">
                ...
                <h3>Mitra Cafe</h3>
                <p>
                    <img src="mitra-cafe.jpg"  width="310" height="300">
